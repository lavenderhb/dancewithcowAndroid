...
public class DbUtils
{
    ...
    {
        DbUtils dao = (DbUtils)daoMap.get(daoConfig.getDbName());
        if (dao == null) {
    ...
    public void saveOrUpdateAll(List<?> entities) throws DbException {
        if ((entities == null) || (entities.size() == 0)) return; try
        {
            beginTransaction();
    ...
    public void deleteById(Class<?> entityType, Object idValue) throws DbException {
        if (!tableIsExist(entityType)) return; try
        {
            beginTransaction();
    ...
    public void delete(Object entity) throws DbException {
        if (!tableIsExist(entity.getClass())) return; try
        {
            beginTransaction();
    ...
    public void deleteAll(List<?> entities) throws DbException {
        if ((entities == null) || (entities.size() == 0) || (!tableIsExist(entities.get(0).getClass()))) return; try
        {
            beginTransaction();
        ...
        if (cursor != null) {
            try {
                if (cursor.moveToNext()) {
                    Object entity = CursorUtils.getEntity(this, cursor, entityType, seq);
                    this.findTempCache.put(sql, entity);
                    Object localObject2 = entity;
    ...
    public DbModel findDbModelFirst(SqlInfo sqlInfo) throws DbException {
        ...
        if (cursor != null) {
            try {
                if (cursor.moveToNext()) {
                    DbModel localDbModel = CursorUtils.getDbModel(cursor);
                    return localDbModel;
                }
            } catch (Throwable e) {
                throw new DbException(e);
    ...
    public long count(Selector selector) throws DbException {
        ...
        if (!tableIsExist(entityType)) return 0L;

        Table table = Table.get(this, entityType);
        DbModelSelector dmSelector = selector.select(new String[] { "count(" + table.id.getColumnName() + ") as count" });
    ...
    public long count(Object entity) throws DbException {
        if (!tableIsExist(entity.getClass())) return 0L;
    ...
    public Cursor execQuery(SqlInfo sqlInfo) throws DbException {
        debugSql(sqlInfo.getSql());
        try {
            return this.database.rawQuery(sqlInfo.getSql(), sqlInfo.getBindArgsAsStrArray()); } catch (Throwable e) {
        }
    ...
    public Cursor execQuery(String sql) throws DbException
    {
        debugSql(sql);
        try {
            return this.database.rawQuery(sql, null); } catch (Throwable e) {
        }
        throw new DbException();
    }
    ...
    private class FindTempCache
    {
        ...
        public void put(String sql, Object result) { if ((sql != null) && (result != null))
